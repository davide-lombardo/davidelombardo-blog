...
export const ICONS = {
  CHEVRON_UP: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-up-icon lucide-chevron-up"><path d="m18 15-6-6-6 6"/></svg>`,
...
export function getSanitizedIcon(
  iconKey: keyof typeof ICONS,
  sanitizer: DomSanitizer
): SafeHtml {
  const iconSvg = ICONS[iconKey];
  return sanitizer.bypassSecurityTrustHtml(iconSvg);
}
